...
public class TriagemEtiqueta {


	public void etiquetar(WebDriver driver, WebDriverWait wait, ChavesResultado resultado, ChavesConfiguracao configuracao)
...
//		resultado.setEtiqueta(preEtiqueta + resultado.getEtiqueta());
		...
		if(ChavesResultado.getSeqPeticao() != null) {

			driver.findElement(By.xpath("//div/div/span/div/table/tbody/tr/td[2]/textarea"))
					.sendKeys("MARK" + Sistema.VERSAO + "\nSEQ PETIÇÃO INICIAL: " + ChavesResultado.getSeqPeticao()
							+ "\nFRASE CHAVE PETIÇÃO INICIAL: " + ChavesResultado.getPalavraChavePeticao());
		}else {
