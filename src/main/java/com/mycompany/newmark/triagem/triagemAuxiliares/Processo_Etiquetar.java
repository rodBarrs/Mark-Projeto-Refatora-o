 ...
 */
package com.mycompany.newmark.triagem;
...
public class Processo_Etiquetar {
	...
	public void etiquetar(WebDriver driver, WebDriverWait wait, Chaves_Resultado resultado, Chaves_Configuracao configuracao)
