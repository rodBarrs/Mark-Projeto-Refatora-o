...
public class TriagemGridMenu {
    private int tamanho = -1;

    public TriagemGridMenu(WebDriver driver) {
        super();
    }

    //Encontra os processos
    @SuppressWarnings("SleepWhileInLoop")
    public final ChavesResultado buscar_processo(WebDriver driver, WebDriverWait wait) throws InterruptedException, UnsupportedFlavorException, IOException, SQLException {
