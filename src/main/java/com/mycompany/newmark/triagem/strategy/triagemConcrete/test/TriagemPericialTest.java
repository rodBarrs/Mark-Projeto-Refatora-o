...
public class TriagemPericialTest {
    ...
    public void testRealizarTriagem() {
        ...
        TriagemPericial triagemPericial = new TriagemPericial();

        try {
            ChavesResultado resultado = triagemPericial.realizarTriagem(driver, wait, configuracao, bancos);
