...
public class TriagemDocumentoTest {
    @Mock
    ...
    public void testRealizarTriagem() {
        ...
        TriagemDocumento triagemDocumento = new TriagemDocumento();

        try {
            ChavesResultado resultado = triagemDocumento.realizarTriagem(driver, wait, configuracao, bancos);
